...
from routers import user, chat, history, explore, syllabus, topics, parent, quotes_router, teacher, config, contest, vector_ingest, video_r2, principal, admin as admin_router
...
app.include_router(video_r2.router)
